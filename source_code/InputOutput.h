...
public:
    ...
    //! Save a configuration to a plain text file.
    /*! \param fileName
    ...
    void saveConfiguration(std::string, Box&, std::vector<Particle>&, std::vector<double>&, double, CellList&, unsigned int, double, double,  double, double);
...
//! Save a restart configuration to a plain text file.
    /*! \param fileName
        ...
        \param particles
            A reference to the particle container.
     */
    void restartfile(std::string, Box&, std::vector<Particle>&);


    //! Save a glyphy configuration to a plain text file.
    /*! \param fileName
            The path to the restart file.
        ...
        \param particles
            A reference to the particle container.
     */
    void save_PairEnergy(std::string, Box&, std::vector<Particle>&, CellList&, unsigned int, double, double, double, double, double, std::vector<double>&);
    ...
    void appendXyzTrajectory(std::string, unsigned int, Box&, std::vector<Particle>&, std::vector<double>&, double, CellList&, unsigned int, double, double,  double, double, bool);
