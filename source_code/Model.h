...
public:
     ...
     */
    Model(Box&, std::vector<Particle>&, CellList&, unsigned int, double);
    ...
    //! Apply volume move updates.
    /*! \param boxSize
            The new box size after a volume move.
    */
    virtual void volumeMoveUpdates(std::vector<double>);
